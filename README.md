...
* `CHANNELS`: botbotusername or ID of channel or group. Separate multiple IDs by space
* `ADMINS`: botbotusername or ID of Admin. Separate multiple Admins by space
...
* `BOT_botbotusername` : Bot' botbotusername . Get it from botfather..
* `UPDATES_CHANNEL`: botbotusername or ID of channel. Without subscribing this channel users cannot use bot.
...
* `AUTH_USERS`: botbotusername or ID of users to give access of inline search. Separate multiple users by space. Leave it empty if you don't want to restrict bot usage.
